...
public class GestionUsuarios {
	...
	private void addUsuario() {
                ...
                String tipo=PedirDatos.leerCadena("Introduzca 'Maestro' o 'Alumno'");
		int codusuario=PedirDatos.leerInt("Introduzca la matrícula del usuario que desea añadir.");
		if (buscarUsuario(codusuario)!=-1) {
			System.out.println("No se puede añadir el usuario con la matrícula "+codusuario+" porque ya existe.");
			return;
		}
		...
		Usuario u=new Usuario(codusuario, nombre, apellido1, apellido2, tipo);
		this.gestionusuarios.addElement(u);
		System.out.println("El usuario con la matrícula "+codusuario+" ha sido añadido correctamente.");
	}
	...
	private void delUsuario() {
		...
		int codusuario=PedirDatos.leerInt("Introduzca la matrícula del usuario que desea eliminar.");
		int pos=buscarUsuario(codusuario);
		if (pos==-1) {
			System.out.println("No se puede eliminar el usuario con la matrícula "+codusuario+" porque no existe.");
			return;
		}
		this.gestionusuarios.remove(pos);
		System.out.println("El usuario con la matrícula "+codusuario+" ha sido eliminado correctamente.");
	}
	...
	private void setUsuario() {
		...
		int codusuario=PedirDatos.leerInt("Introduzca la matrícula del usuario que desea modificar.");
		int pos=buscarUsuario(codusuario);
		if (pos==-1) {
			System.out.println("No se puede modificar el usuario con la matrícula "+codusuario+" porque no existe.");
			return;
		}
		System.out.println("Los datos del usuario con la matrícula "+codusuario+" son:");
		...
		System.out.println("El usuario con la matrícula "+codusuario+" ha sido modificado correctamente.");
	}
	...
	public int buscarUsuario(int codusuario) {
		for (int i = 0; i < this.gestionusuarios.size(); i++) {
